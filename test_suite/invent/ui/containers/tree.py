...
class Tree(Widget):
    ...
    def make_branch(self, parent, label, subtree):
        ...
        details_element = details(
            summary(Label(name=label, text=label).render())
        )
