...
class App:
    ...
    The `go` method is used to start the app. This is typically called at the
    end of the script that defines the app.
    ...
    app.append(
        ...
        Page(
            ...
            title="About",
            children=[
                Label(text="This app is created by me."),
            ],
        ),
    )
    app.go()
    ...
    def __init__(
        ...
        *args,
        ...
        self._page_lookup_table = {}  # A dict to easily look up pages by id.
        self._current_page = None  # The id of the currently visible page.
        if args:
            self.append(*args)
        if pages:
            self.append(*pages)
    ...
    def remove(self, *page_ids):
        """
        Remove one or more Page objects, referenced by `page_id`, from the app.
        """
    ...
    def get_page(self, page_id):
        """
        Return the page with the specified `page_id` or raise a KeyError if no such
        page exists.
        """
        if page_id in self._page_lookup_table:
    ...
    def show_page(self, page_id):
        """
        Show the page with the specified `page_id`. Hide the current page if there
        is one.
        """
