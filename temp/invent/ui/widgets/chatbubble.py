...
class ChatBubble(Widget):
	...
	def render(A):B=web.div(classes=[_A]);B.addEventListener('click',lambda event:A.publish('clicked',author_name=A.author_name,author_image=A.author_image,timestamp=A.timestamp,content=A.content));return B