...
class Carousel(Component):
	children=ListProperty(_('The child items to display in the carousel.'),default_value=None);current_index=IntegerProperty(_('The index of the currently displayed item in the carousel.'),default_value=0,min_value=0);transition=ChoiceProperty(_('The transition effect to use when moving between items.'),choices=[_B,'slide'],default_value=_B)
	@classmethod
